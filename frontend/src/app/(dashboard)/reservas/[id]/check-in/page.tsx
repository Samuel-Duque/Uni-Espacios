// frontend/src/app/(dashboard)/reservas/[id]/check-in/page.tsx
'use client';
...
export default function CheckInPage({ params }: CheckInPageProps) {
  ...
  const checkInMutation = useMutation({
    ...
    onError: (err: unknown) => {
      const msg = err instanceof ApiError ? err.message : 'Error al registrar el Check-In';
      toast.error(msg);
    },
  });
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 max-w-4xl">
      ...
      {isLoading ? (
        <div className="py-24 flex flex-col items-center justify-center text-slate-500 bg-white rounded-2xl border border-slate-200 shadow-xs">
          ...
          <span className="text-xs font-semibold">Cargando datos del acta de Check-In...</span>
        </div>
